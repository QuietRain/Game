class GameMap {
    ...
    public constructor(stage: any) {
        ...
        for (var i = 0; i < this._map.length; i++) {
            ...
            bm.addEventListener(egret.TouchEvent.TOUCH_TAP, (e: egret.TouchEvent) => {//找格子
    ...
    public moveTo(x: number, y: number, callback: Function) {
        ...
        if (astar.findPath(this.getNode(startXpos, startYpos), this.getNode(endXpos, endYpos)) &&
            ...
            this.interval = setInterval(() => {
                ...
                _statemachine.endX = Math.floor(pos.x * this.Boxsize);
                _statemachine.endY = Math.floor(pos.y * this.Boxsize);
